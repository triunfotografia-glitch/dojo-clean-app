...
export default function EditarGraduacao() {
  const { id } =
  ...
  useEffect(() => {
    ...
    async function carregar() {
      try {
        ...
        setFaixa(graduacao.faixa || '');
        setData(graduacao.data || '');
        setProfessor(
          graduacao.professor || 'Não informado'
        );
        setObservacao(
        ...
        Alert.alert(
          'Erro',
          'Não foi possível carregar a graduação.'
        );
      }
    }
