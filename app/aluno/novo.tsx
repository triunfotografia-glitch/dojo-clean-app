...
export default function NovoAluno() {
  ...
  async function salvarAluno() {
    ...
    if (
      ...
      Alert.alert(
        "Atenção",
        "Informe nome, faixa e e-mail do aluno."
      );
    ...
    /*
     * ID temporário usado somente pelo frontend
     * para satisfazer a interface Aluno.
     *
     * O backend remove esse campo antes do INSERT
     * e o PostgreSQL gera o ID definitivo.
     */
    const id =
      Date.now().toString();
      ...
      >
        ...
        {professores.filter(
          ...
          <Text style={styles.helperText}>
            Cadastre um professor antes de
            vinculá-lo a um aluno.
          </Text>
